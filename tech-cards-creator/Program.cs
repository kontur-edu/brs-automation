...
namespace tech_cards_creator
{
    internal class Program
    {
        ...
        public const int CourseYear = 4;
        
        // Нужно залогиниться вручную в браузере и скопировать из DevTools - Application - Cookie JSESSIONID:
        public const string JsessionidCookie = "6DCC48E36DD3CB0E93164C4E39797BBA";
        ...
        static async Task Main()
        {
            ...
            while (true)
            {
                await page.GotoAsync(
                    $"https://brs.urfu.ru/mrd/mvc/mobile/view/technologyCard/{Year}/{YearPart}/{CourseYear}/its");
